...
class CriteriaQueryBuilder {
    ...
    public CriteriaQueryBuilder limit(Integer start, Integer end) {
    ...
    public Object[] values() {
        List<Object> allValues = new ArrayList<Object>(values.size());
    ...
    public static void main(String[] args) {
        System.out.println(
                new CriteriaQueryBuilder("select from t_Victor_es_xenofobo")
                        .whereEquals("id", 1)
                        .whereBetween("queseyo", 1, 2)
                        .whereLike("name", "Victor")
                        .whereIn("lista", 1, 2, 3, 4)
                        .whereClause("parametro like '%' or otro_param like '%' ")
                        .orderBy("phobia", false)
                        .orderBy("intensity", true)
                        .limit(1, 10)
                        .sql());
    }
