with stop_area_tmp(id, "desc", sort_order, lng, lat) as (
  ...
  select 'ITURREGUI',          'Terminal Iturregui',      24, -65.99220,  18.42170 union
  select 'CAROLINA',           'Terminal Carolina',       25, -65.95370,  18.38630 union
  select 'PDA18',              'Parada 18',               26, -66.07410,  18.45060
)
