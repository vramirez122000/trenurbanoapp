...
-- Terminal de Caguas a Villa del Rey Lunes a Viernes
with trip as ( 
  SELECT 
   'VR' route,
   'TERM_CAGUAS' stop_area, 
   'VILLAS_DEL_REY' direction,
...
-- Terminal de Caguas a Villa del Rey Fin de Semana
with trip as ( 
  SELECT 
   'VR' route,
   'TERM_CAGUAS' stop_area, 
