...
-- Terminal de Caguas a Bo. San Antonio, Sect. Salchichón, Lunes a Viernes
with trip as (
    SELECT
      'SS' route,
      'TERM_CAGUAS' stop_area,
      'SAN_SALVADOR' direction,
...
-- Terminal de Caguas a Bo. San Antonio, Sect. Salchichón, Sabado y domingo
