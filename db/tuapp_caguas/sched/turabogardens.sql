...
-- Terminal de Caguas a Turabo Gardens Lunes a Viernes
with trip as ( 
  SELECT 
   'TG' route,
   'TERM_CAGUAS' stop_area, 
   'TURABO_GARDENS' direction, 
 ...
 union select '16:20:00'
 union select '16:40:00'
...
-- Terminal de Caguas a Turabo Gardens Fin de Semana
with trip as ( 
  SELECT 
   'TG' route,
   'TERM_CAGUAS' stop_area, 
